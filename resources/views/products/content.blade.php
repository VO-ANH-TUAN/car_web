...
<div class="container p-t-80">
                                    ...
                                    <form action="/add-cart" method="post">
                                        @if ($product->price !== NULL)
                                            <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                                ...
                                                <input class="mtext-104 cl3 txt-center num-product"id="number" type="number" name="num_product"value="1" min="1" max="3">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="#description" role="tab">Thông tin chi tiết </a>
						</li>
    ...
    <section class="sec-relate-product bg0 p-t-45 p-b-105">
        <div class="container">
            <div class="p-b-45">
                <h3 class="ltext-106 cl5 txt-center" style="font-family: Arial, Helvetica, sans-serif; font-style: inherit;">
